...
export default function Chats(){
  ...
  const {setSelectedChat,selectedChat,setChats,chats} = useContext(UserContext)
            ...
            <div className='flex flex-col gap-2 h-2/10'>
              <div className='flex flex-row justify-between items-center p-5'>
                ...
                <div className=' flex flex-row gap-2'>
                   <div className='text-zinc-400 transition-colors cursor-pointer hover:bg-slate-800 rounded-full p-2'><AddCommentIcon></AddCommentIcon></div>
                   <div className='text-white transition-colors cursor-pointer hover:bg-slate-800 rounded-full p-2'><MoreVertIcon></MoreVertIcon></div>
                </div>
                        ...
                        <div key={i}
                         ...
                         onClick={()=>{handleclick(chat)}}>
                            ...
                            <div className='text-zinc-400 w-full overflow-hidden text-nowrap flex flex-col justify-center'>
                                ...
                                <div className='flex flex-row'> <DoneAllIcon fontSize='small'> </DoneAllIcon> <p>{chat.lastMessage.description}</p></div> 
